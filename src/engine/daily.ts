...
> = {
  인성: {
    headlines: {
      상: ["배움과 귀인의 기운이 가득한 날 ✨", "도와주는 손길이 닿는 하루", "머리가 맑고 집중이 잘 되는 날", "노력이 결실로 이어지는 날", "좋은 정보·인연이 들어오는 날"],
      중: ["차분히 채우기 좋은 하루", "기본기에 충실하면 무난한 날", "서두르지 않으면 술술 풀려요", "여유를 갖고 채워가는 하루", "기초를 다지기 좋은 날"],
      하: ["조금 느려도 괜찮은 날", "욕심보다 휴식이 약이 되는 하루", "받기보다 비우기 좋은 날", "잠시 충전이 필요한 날", "무리보다 회복이 먼저인 하루"],
    },
  ...
  식상: {
    headlines: {
      상: ["표현하고 베풀수록 빛나는 날 🎨", "아이디어가 팡팡 터지는 하루", "말과 글에 힘이 실리는 날", "재능이 술술 나오는 날", "주목받기 좋은 하루"],
      중: ["가볍게 시작해보기 좋은 하루", "손을 움직이면 풀리는 날", "작은 시도가 즐거운 날", "재미있는 일이 생기는 하루", "가볍게 표현해보면 좋은 날"],
      하: ["말은 아끼는 게 좋은 하루", "에너지를 안으로 모으는 날", "무리한 표현은 다음에", "조용히 정리하기 좋은 날", "입보다 손이 편한 하루"],
    },
  ...
  재성: {
    headlines: {
      상: ["기회와 재물의 기운이 도는 날 💰", "움직인 만큼 들어오는 하루", "감 잡은 일에 속도 내기 좋은 날", "노력이 돈으로 이어지는 날", "거래운이 따르는 하루"],
      중: ["실속을 챙기기 좋은 하루", "과욕만 빼면 무난한 날", "꼼꼼히 챙기면 이득인 날", "알뜰함이 빛나는 하루", "기회를 살피기 좋은 날"],
      하: ["지갑은 닫아두기 좋은 날", "큰 결정은 미루는 하루", "숫자를 한 번 더 확인할 날", "씀씀이를 점검할 하루", "작은 손해는 넘기기 좋은 날"],
    },
  ...
  관성: {
    headlines: {
      상: ["책임지고 인정받는 기운의 날 💼", "맡은 일이 술술 인정받는 하루", "공적인 자리에서 빛나는 날", "노력이 인정받는 날", "맡은 일이 잘 풀리는 하루"],
      중: ["규칙을 지키면 유리한 하루", "차근차근이 답인 날", "맡은 만큼만 하면 되는 날", "성실함이 통하는 하루", "기본을 지키면 좋은 날"],
      하: ["무리한 약속은 피할 하루", "압박은 흘려보내기 좋은 날", "욱하지 않으면 무사한 날", "어깨 힘을 빼도 되는 날", "압박은 내려놓기 좋은 하루"],
    },
  ...
  비겁: {
    headlines: {
      상: ["내 페이스가 잘 통하는 날 🤝", "동료·친구와 시너지 나는 하루", "주관을 세우기 좋은 날", "내 매력이 통하는 날", "사람들이 따르는 하루"],
      중: ["함께하면 든든한 하루", "내 속도로 가면 되는 날", "경쟁보다 협력이 좋은 날", "마이웨이가 통하는 하루", "협력이 잘 되는 날"],
      하: ["고집은 잠시 내려둘 하루", "혼자 끌어안지 않기 좋은 날", "비교는 접어두는 날", "남 신경 끄기 좋은 날", "내 속도를 지킬 하루"],
    },
